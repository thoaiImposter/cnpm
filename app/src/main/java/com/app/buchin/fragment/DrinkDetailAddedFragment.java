...
public class DrinkDetailAddedFragment extends Fragment {
    ...
    public DrinkDetailAddedFragment(Drink drink) {
        this.mDrink = drink;
    }
                    ...
                    if (getActivity() != null) {
                        MyApplication.get(getActivity()).getHistoryDatabaseReference()
                                ...
                                .setValue(history, (error, ref) -> {
                                    GlobalFuntion.showToast(getActivity(), getString(R.string.msg_add_drink_success));
                    ...
                    if (getActivity() != null) {
                        MyApplication.get(getActivity()).getHistoryDatabaseReference()
                                ...
                                .updateChildren(map, (error, ref) -> {
                                    GlobalFuntion.hideSoftKeyboard(getActivity());
                                    GlobalFuntion.showToast(getActivity(), getString(R.string.msg_edit_add_history_success));
                                    changeQuantity(history.getDrinkId(), Integer.parseInt(strQuantity) - history.getQuantity(), true);
        ...
        new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(getString(R.string.action_delete), (dialogInterface, i)
                        ...
                        .removeValue((error, ref) -> {
                            GlobalFuntion.showToast(getActivity(), getString(R.string.msg_delete_add_history_success));
