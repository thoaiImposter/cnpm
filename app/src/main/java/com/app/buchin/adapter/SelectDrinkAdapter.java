...
public class SelectDrinkAdapter extends ArrayAdapter<Drink> {

    private final Context context;

    public SelectDrinkAdapter(@NonNull Context context, @LayoutRes int resource,
                              @NonNull List<Drink> list) {
